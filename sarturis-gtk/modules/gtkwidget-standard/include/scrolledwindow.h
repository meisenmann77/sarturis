...
#ifndef __SCROLLEDWINDOW__
#define __SCROLLEDWINDOW__
...
namespace sarturis
{
  namespace gtk
  {
    class ScrolledWindow : public ActiveWidget
    {
      public:
        // Konstruktor
        ScrolledWindow(sarturis::ref<Widget> Child, bool ScrollX, bool ScrollY);
